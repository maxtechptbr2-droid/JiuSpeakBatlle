        ...
        <div className="space-y-4" id="bjj-student-panel-quick-access">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 gap-4 sm:gap-5">
            {[
              ...
              { id: 'community', title: 'Comunidade', description: 'Conecte-se com outros praticantes, participe de discussões e compartilhe experiências.', icon: Users, color: 'border-pink-500/10 text-pink-400 bg-pink-500/5', iconBg: 'bg-pink-500/10 text-pink-400' },
