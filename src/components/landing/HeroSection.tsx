  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(15,23,42,0.1)_1px,transparent_1px),linear-gradient(to_bottom,rgba(15,23,42,0.1)_1px,transparent_1px)] bg-[size:4.5rem_4.5rem] opacity-30" />
      </div>

      {/* Overlay: z-10 */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#040914]/98 via-[#010611]/90 to-[#00040a]/65 z-10 pointer-events-none" />
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-24 lg:py-32 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        ...
        <div className="lg:col-span-6 space-y-6 md:space-y-8 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-950/40 border border-blue-500/20 text-blue-400 text-[10px] font-mono font-black uppercase tracking-widest mx-auto lg:mx-0">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-sans font-black tracking-tighter leading-[1.05] text-white uppercase select-none flex flex-col">
              ...
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#009dff] via-[#00bfff] to-blue-600">
                SPEAK GLOBALLY.
              </span>
            </h1>
            
            {/* Mockup Subtitle */}
            <p className="text-slate-305 text-base sm:text-lg lg:text-xl font-medium leading-relaxed max-w-xl mx-auto lg:mx-0">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 w-full">
            <CTAButton 
              ...
              className="w-full sm:w-auto px-10 py-4 text-sm uppercase tracking-widest shrink-0 transition-transform duration-200 hover:scale-[1.02]"
            />
            
            {!isLoggedIn && (
              <button
                onClick={onExploreClick}
                className="w-full sm:w-auto px-6 py-3.5 bg-transparent hover:bg-blue-950/20 border border-blue-500/25 hover:border-blue-500/50 text-blue-400 hover:text-white rounded-xl text-xs font-black uppercase tracking-wider transition-all duration-300 cursor-pointer whitespace-nowrap shrink-0"
              >
                Explorar as Faixas
              </button>
            )}
        ...
        <div className="lg:col-span-6 relative flex justify-center items-center lg:pl-6">
          ...
          <div className="relative w-full max-w-[90vw] sm:max-w-[500px] aspect-[4/5] rounded-[2.5rem] bg-[#02050e] border border-blue-500/20 overflow-hidden shadow-2xl transition-all duration-300 hover:border-blue-500/35 group">
            ...
            <div className="absolute top-8 left-1/4 w-32 h-32 bg-blue-500/10 rounded-full blur-[24px] pointer-events-none" />
            <div className="absolute top-12 right-1/4 w-40 h-40 bg-indigo-500/10 rounded-full blur-[30px] pointer-events-none" />

            {/* Neon Blue laser light streams */}
            <div className="absolute top-0 left-12 w-[1px] h-full bg-gradient-to-b from-[#00bfff]/20 via-blue-500/5 to-transparent pointer-events-none" />
            <div className="absolute top-0 right-16 w-[1px] h-full bg-gradient-to-b from-[#009dff]/15 via-indigo-400/5 to-transparent pointer-events-none" />
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-8 z-30 select-none">
              ...
              <div className="absolute inset-0 flex items-center justify-center transition-transform duration-500 group-hover:scale-[1.01]">
                ...
                <div className="relative w-[340px] h-[440px] flex flex-col items-center justify-end mt-12">
                  ...
                  <div className="absolute bottom-[-15px] w-72 h-[350px] bg-slate-100 rounded-t-[5.5rem] border-x-[5px] border-t-[9px] border-slate-350 shadow-[0_15px_30px_rgba(0,0,0,0.4)] flex flex-col items-center justify-start pt-12">
                    ...
                    <div className="z-20 text-center mt-12 space-y-2 pointer-events-none">
                      
                      {/* Stylized diamond-chevron crest emblem above the branding */}
                      <div className="mx-auto w-12 h-12 flex items-center justify-center text-blue-600 font-sans font-black bg-slate-100 shadow-sm border border-slate-200 flex-col relative rounded-lg">
                        <span className="text-2xl text-[#009dff] leading-none">▲</span>
                        <span className="text-[8px] text-[#009dff] leading-none tracking-widest mt-[-2px]">🥋</span>
                      </div>

                      {/* Clean high-contrast bold lettering as in the gi mockup */}
                      <h3 className="font-sans font-black tracking-[0.25em] text-[#0a1122] uppercase text-4xl block">
                        JIUSPEAK
                      </h3>
                    ...
                    <div className="absolute bottom-16 left-6 w-[2px] h-32 bg-slate-300/30 rotate-15" />
                    <div className="absolute bottom-20 right-6 w-[2px] h-28 bg-slate-300/30 -rotate-15" />
                    <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-[1.5px] h-36 bg-slate-300/20" />
                  </div>
              ...
              <div className="space-y-1 relative z-30 font-sans">
                ...
                <p className="text-xs sm:text-sm font-sans font-extrabold text-white uppercase tracking-tight">
          ...
          <div className="absolute -bottom-4 right-4 sm:-right-4 md:-right-6 bg-slate-950/95 border border-blue-500/30 rounded-2xl p-4 shadow-xl flex items-center gap-3 z-40 max-w-xs transition-transform duration-300 hover:translate-y-[-4px]">
            <div className="w-11 h-11 rounded-xl bg-blue-950/60 border border-blue-500/20 flex items-center justify-center text-blue-450 shrink-0">
              <Trophy className="w-6 h-6 text-[#00bfff]" />
            </div>
            <div>
              <span className="text-[9px] uppercase font-mono font-black text-[#00bfff] tracking-widest block">
                GLOBAL SYSTEM
              </span>
              <span className="text-xs font-sans font-black text-white block uppercase tracking-tight">
                CERTIFICADO IBJJF
              </span>
              <span className="text-[9px] text-slate-400">Desenvolva a oratória de campeão mundial</span>
            </div>
          </div>
