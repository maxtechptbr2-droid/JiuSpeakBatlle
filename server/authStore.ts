...
export const authStore = {
  ...
  async updateUser(id: string, fields: Partial<AuthUser>): Promise<boolean> {
    ...
    try {
      ...
      if (fields.birthDate !== undefined) prismaData.birthDate = fields.birthDate;
      if (fields.phone !== undefined) prismaData.phone = fields.phone;
      ...
      if (fields.favoriteTechnique !== undefined) prismaData.favoriteTechnique = fields.favoriteTechnique;
      if (fields.favoriteAthlete !== undefined) prismaData.favoriteAthlete = fields.favoriteAthlete;
      if (fields.privacyLevel !== undefined) prismaData.privacyLevel = fields.privacyLevel;
      if (fields.followersCount !== undefined) prismaData.followersCount = fields.followersCount;
      if (fields.followingCount !== undefined) prismaData.followingCount = fields.followingCount;
